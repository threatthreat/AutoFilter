...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002345626874').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002374553598'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002646558937'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002646558937'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002525980798'))  # Premium logs channel id
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002275381683 -1002687114622').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'grezy8007@okhdfcbank')
...
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATIONvjcollection', False))  # Notification On (True) / Off (False)
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002345626874'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/Bombardiro_Crocodiloa')  # How to open tut
...
SHORTLINK_API = environ.get('SHORTLINK_API', '659546a38bd0c5480b3b76bf63f2d982c21c93cf')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Bombardiro_Crocodiloa')  # Tutorial video link for opening shortlink website/shortlink https://vipurl.in/ 350e1c2b56b3162b0259542340b957f200deebe3
